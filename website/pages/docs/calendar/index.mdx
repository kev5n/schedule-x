...
```bash copy
npm i trinity-calendar @schedule-x/theme-default
```
...
```ts
import { createCalendar, createViewMonthGrid } from 'trinity-calendar'
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/trinity-calendar@2.2.0/dist/core.umd.js"></script>
