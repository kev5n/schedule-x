...
download peer dependencies, you will additionally need to install `trinity-calendar`, `@preact/signals` and
...
<script lang="ts">
	...
	import { createCalendar, createViewDay, createViewWeek } from 'trinity-calendar';
