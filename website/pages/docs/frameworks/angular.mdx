...
<Tabs items={['npm', 'pnpm/yarn']}>
  <Tabs.Tab>
    ```bash copy
      npm install @schedule-x/angular trinity-calendar @schedule-x/theme-default
    ```
  </Tabs.Tab>

  <Tabs.Tab>
    ```bash copy
      pnpm install @schedule-x/angular trinity-calendar @schedule-x/theme-default @preact/signals preact
    ```
  </Tabs.Tab>
</Tabs>
...
import { createCalendar, createViewWeek } from "trinity-calendar";
